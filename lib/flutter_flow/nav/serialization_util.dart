  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UsersAddressRow:
            return UsersAddressRow(data);
          case FurnituresRow:
            return FurnituresRow(data);
          case SubcollectionFurnitureRow:
            return SubcollectionFurnitureRow(data);
          case FavoritesListRow:
            return FavoritesListRow(data);
          case UsersRow:
            return UsersRow(data);
          case CheckoutRow:
            return CheckoutRow(data);
          case CartsCollectionRow:
            return CartsCollectionRow(data);
          default:
            return null;
        }
