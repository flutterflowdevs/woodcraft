...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE68314);
  late Color secondary = const Color(0xFF284F49);
  late Color tertiary = const Color(0xFFF2F0E0);
...
class ThemeTypography extends Typography {
  ...
  String get displayLargeFamily => 'LufgaRegular';
